...
The final steps is to make a request to judo with the response received from Android Pay. To do this, create an AndroidPayRequest using the Builder with the required fields.
